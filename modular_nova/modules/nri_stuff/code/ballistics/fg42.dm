/obj/item/gun/ballistic/automatic/fg42
	...
	fire_sound = 'modular_nova/modules/nri_stuff/sound/guns/fire/fg42_fire.ogg'

	rack_sound = 'modular_nova/modules/nri_stuff/sound/guns/interact/batrifle_cock.ogg'
	load_sound = 'modular_nova/modules/nri_stuff/sound/guns/interact/batrifle_magin.ogg'
	load_empty_sound = 'modular_nova/modules/nri_stuff/sound/guns/interact/batrifle_magin.ogg'
	eject_sound = 'modular_nova/modules/nri_stuff/sound/guns/interact/batrifle_magout.ogg'
	eject_empty_sound = 'modular_nova/modules/nri_stuff/sound/guns/interact/batrifle_magout.ogg'
